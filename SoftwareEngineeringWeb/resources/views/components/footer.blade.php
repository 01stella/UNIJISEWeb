    ...
    <div class="relative z-10 w-full max-w-[1250px] mx-auto px-6 lg:px-8 pt-16 pb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16 items-stretch">
            ...
            <div class="lg:col-span-2 lg:col-start-6">
                ...
                <ul class="space-y-3 m-0 p-0 list-none text-[14px] font-medium">
                    <li><a href="/home/about?tab=profile" class="text-white/70 hover:text-white hover:translate-x-1 inline-block transition-all no-underline">Study Program</a></li>
                    <li><a href="/home/curriculum?tab=structure" class="text-white/70 hover:text-white hover:translate-x-1 inline-block transition-all no-underline">Curriculum</a></li>
                    <li><a href="/home/academic?tab=guidelines" class="text-white/70 hover:text-white hover:translate-x-1 inline-block transition-all no-underline">Academic Info</a></li>
                    <li><a href="/home/about?tab=lecturer" class="text-white/70 hover:text-white hover:translate-x-1 inline-block transition-all no-underline">Faculty Members</a></li>
                    <li><a href="/home/academic?tab=downloads" class="text-white/70 hover:text-white hover:translate-x-1 inline-block transition-all no-underline">Download Center</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://www.instagram.com/unijiofficial" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#D4AF37] hover:text-[#5B1E22] hover:-translate-y-1 transition-all duration-300">
